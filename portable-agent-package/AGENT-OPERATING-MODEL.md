...
| Council-converge (multi-reviewer + chair, anchored 1-5 rubric, min-score) | Internal — `my-lib/skills/northwind-council-converge/`; rubric design echoes IRR (inter-rater reliability) literature. |
