...
version: 2.0.1
summary: "macOS Phase 1 for GETTING_STARTED.md: Xcode CLT + Homebrew + package installs (setup_system.sh is Debian/Ubuntu-only and will not run on a Mac). Rejoin GETTING_STARTED.md at Phase 2."
created: 2026-02-18
...
## Continue in GETTING_STARTED.md

Rejoin **[GETTING_STARTED.md at Phase 2](./GETTING_STARTED.md#phase-2-connect-your-terminal-to-github)** (Connect Your Terminal to GitHub) and follow it to the end. Two Mac adjustments as you go:
