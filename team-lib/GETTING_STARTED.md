...
# Getting Started: Blank Computer → Your Own Named Agent
...
## Two ways in — pick one now

This one guide covers both. They share Phases 0–4; they differ only in what you drive the agent
*from*.

| | **Terminal** (default) | **Desktop app** |
|---|---|---|
...
Most contributors branch directly on `Pvragon/pvragon-ai-library` (see Phase 8 above). If you prefer the extra isolation of a fork — you literally cannot touch `main` — use this flow instead.
